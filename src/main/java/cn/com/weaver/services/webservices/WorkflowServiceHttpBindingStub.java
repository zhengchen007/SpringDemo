...
public class WorkflowServiceHttpBindingStub extends org.apache.axis.client.Stub implements WorkflowServicePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "in0"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://webservices.workflow.weaver", "WorkflowRequestInfo"), weaver.workflow.webservices.WorkflowRequestInfo.class, false, false);
        ...
        oper.setReturnClass(weaver.workflow.webservices.WorkflowRequestInfo.class);
        oper.setReturnQName(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "out"));
        oper.setStyle(org.apache.axis.constants.Style.WRAPPED);
        oper.setUse(org.apache.axis.constants.Use.LITERAL);
        _operations[4] = oper;
    ...
    private static void _initOperationDesc2(){
        ...
        oper.setReturnClass(weaver.workflow.webservices.WorkflowBaseInfo[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "out"));
        param = oper.getReturnParamDesc();
        ...
        oper.setReturnClass(weaver.workflow.webservices.WorkflowRequestLog[].class);
        oper.setReturnQName(new javax.xml.namespace.QName("webservices.services.weaver.com.cn", "out"));
        param = oper.getReturnParamDesc();
    ...
    public WorkflowServiceHttpBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            cls = weaver.workflow.webservices.WorkflowBaseInfo[].class;
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowDetailTableInfo[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowRequestInfo[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowRequestLog[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowRequestTableField[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowRequestTableRecord[].class;
            cachedSerClasses.add(cls);
            ...
            cachedSerQNames.add(qName);
            cls = weaver.workflow.webservices.WorkflowMainTableInfo.class;
            cachedSerClasses.add(cls);
            cachedSerFactories.add(beansf);
            cachedDeserFactories.add(beandf);
 ...
 try {        Object _resp = _call.invoke(new Object[] {new Integer(in0), new Integer(in1)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (weaver.workflow.webservices.WorkflowRequestInfo) _resp;
            } catch (Exception _exception) {
                return (weaver.workflow.webservices.WorkflowRequestInfo) org.apache.axis.utils.JavaUtils.convert(_resp, weaver.workflow.webservices.WorkflowRequestInfo.class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        Object _resp = _call.invoke(new Object[] {new Integer(in0), new Integer(in1), new Integer(in2), new Integer(in3), new Integer(in4), in5});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (weaver.workflow.webservices.WorkflowBaseInfo[]) _resp;
            } catch (Exception _exception) {
                return (weaver.workflow.webservices.WorkflowBaseInfo[]) org.apache.axis.utils.JavaUtils.convert(_resp, weaver.workflow.webservices.WorkflowBaseInfo[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
 ...
 try {        Object _resp = _call.invoke(new Object[] {in0, in1, new Integer(in2), new Integer(in3), new Integer(in4)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            extractAttachments(_call);
            try {
                return (weaver.workflow.webservices.WorkflowRequestLog[]) _resp;
            } catch (Exception _exception) {
                return (weaver.workflow.webservices.WorkflowRequestLog[]) org.apache.axis.utils.JavaUtils.convert(_resp, weaver.workflow.webservices.WorkflowRequestLog[].class);
            }
        }
  } catch (org.apache.axis.AxisFault axisFaultException) {
  throw axisFaultException;
