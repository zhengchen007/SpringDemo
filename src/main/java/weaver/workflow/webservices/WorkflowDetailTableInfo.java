...
public class WorkflowDetailTableInfo  implements java.io.Serializable {
    ...
    private weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords;
    ...
    public WorkflowDetailTableInfo(
           ...
           String tableTitle,
           weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
     ...
     */
    public weaver.workflow.webservices.WorkflowRequestTableRecord[] getWorkflowRequestTableRecords() {
        return workflowRequestTableRecords;
    }
     ...
     */
    public void setWorkflowRequestTableRecords(weaver.workflow.webservices.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
        this.workflowRequestTableRecords = workflowRequestTableRecords;
    }
